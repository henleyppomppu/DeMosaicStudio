...
**Version:** 3.1 — pre-implementation control gaps closed (supersedes 3.0)
**Distribution:** **Personal use only. This software is not distributed to anyone.** See §2.4 and D-11.
**Version history:** `prd.v1.0-original.md` (original), `prd.v2.0.md` (implementation-ready), `prd.v3.0.md` (personal-use scope)
